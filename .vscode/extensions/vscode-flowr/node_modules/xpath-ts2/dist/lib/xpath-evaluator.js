...
exports.XPathEvaluatorImpl = void 0;
...
class XPathEvaluatorImpl {
    ...
    createExpression(e, r) {
        try {
            ...
            throw new xpath_exception_1.XPathException(xpath_exception_1.XPathException.INVALID_EXPRESSION_ERR, err);
        }
    }
    createNSResolver(n) {
...
function convertNSResolver(resolver) {
    ...
    else if (!(0, types_1.isNSResolver)(resolver)) {
        const pr = resolver;
        return {
